...
module ActsAsDynamicModel
  ...
  module AddActAsMethods
      ...
      def init_setup(columns,options)
        ...
        self.columns.each do |column|
          ...
          tmp_columns_setup= { :name                => column.name,
                               ...
                               :column_name         => column.name.humanize,
                               :label_name          => nil,
                               :column_text         => nil,
        ...
        columns_setup = init_dynamic_model_from_setup(columns_setup) if self.respond_to?("init_dynamic_model_from_setup")
    ...
    #   fill order_load
        ...
        tmp_columns_order = columns_setup.collect{|hsh|hsh[:order]||0}
        index=0    
