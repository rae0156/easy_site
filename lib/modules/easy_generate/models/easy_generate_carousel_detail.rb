...
class EasyGenerateCarouselDetail < ActiveRecord::Base
  ...
  acts_as_dynamic_model([
                        ...
                        { :only_field_defined=>true, 
                          :audit_model=>false, 
                          :fixed_attributes => {:media_type => 'carousel'}, 
                          :dynamic_search_exists => false, 
                          :sequence_exists => true, 
                          :parent_exists => true,
                          :instance_name => "Images d'un carousel"
                        }) 
  acts_as_audited :keep_text          => true,
                  :child_attrs => {:es_category => :name },
                  :model_audit_label  => "Carousel - Détail".trn,
