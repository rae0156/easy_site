...
class MenuDetail < ActiveRecord::Base
  ...
  acts_as_dynamic_model([
                          ...
                          {:name              => "controller",
                           :label_name        => "Menu d'un module",
                           :column_name       => "Menu d'un module",
                           :type              => "list_group",
                           :value_list_method => "list_menu",
                           :display_list      => false, 
                           :order             => 5
                          }, 
                          {:name              => "dummy_2",
                        ...
                        { :only_field_defined=>true, 
                          :audit_model=>false, 
                          :fixed_attributes => {:link_type => 'link', :link_params => "[MENU]"}, 
  ...
  def list_menu
    return EsModule.get_menu_by_module
  end
