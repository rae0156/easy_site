...
class MenuHorizontal < ActiveRecord::Base
  ...
  acts_as_dynamic_model([
                        ...
                        { :only_field_defined=>true, 
                          :audit_model=>false, 
                          :fixed_attributes => {:link_type => 'horizontal', :sequence => 1}, 
                          :dynamic_search_exists => false, 
                          :sequence_exists => true, 
                          :parent_exists => true,
                          :instance_name => 'Menu horizontal'

                        }) 
  acts_as_audited :keep_text          => true,
                  :child_attrs => {:es_category => :name, :es_site => :code  },
                  :model_audit_label  => "Menu horizontal".trn,
