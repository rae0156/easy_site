require File.dirname(__FILE__) + "/userstamp/stamper"
require File.dirname(__FILE__) + "/userstamp/stampable"
require File.dirname(__FILE__) + "/userstamp/migration_helper"
